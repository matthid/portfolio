...
public class INGDiBaPDFExtractorTest
{
    ...
    public void testWertpapierKauf01()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(533.39))));
    ...
    public void testWertpapierKauf02()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(726.28))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(726.28))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
    ...
    public void testWertpapierKauf03()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(1027.40))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(1012.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(2.50 + 9.90 + 3.00))));
    }
    ...
    public void testWertpapierKauf04()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(49.14))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(0.86))));
    }
    ...
    public void testWertpapierKauf07()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(5009.71))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(4997.22))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
    ...
    public void testWertpapierKauf08()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(75.00))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(75.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
    ...
    public void testWertpapierKauf09()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(297.15))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(294.25))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(2.90))));
    }
    ...
    public void testWertpapierKauf10()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(1335.07))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(1311.99))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(14.90 + 8.18))));

        var grossValueUnit = entry.getPortfolioTransaction().getUnit(Unit.Type.GROSS_VALUE)
                        .orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("USD", Values.Amount.factorize(1503.75))));
    }

    @Test
    public void testWertpapierKauf10WithSecurityinEUR()
    {
        var security = new Security("Rivian Automotive Inc. Reg.Shares Cl.A  DL -,0001", "EUR");
    ...
    public void testWertpapierKauf11()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(110.00))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(110.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
        ...
        var grossValueUnit = entry.getPortfolioTransaction().getUnit(Unit.Type.GROSS_VALUE)
                        .orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("USD", Values.Amount.factorize(109.85))));
    }

    @Test
    public void testWertpapierKauf11WithSecurityinEUR()
    {
        var security = new Security("Fr.Temp.Inv.Fds -F.Technol. Fd Namens-Anteile A (acc.) o.N.", "EUR");
    ...
    public void testWertpapierKauf12()
    {
        ...
        assertThat(entry.getNote(),
                        is("Ordernummer 274272365.001 | Stückzinsen EUR 0,10 (Zinsvaluta 17.11.2022 357 Tage)"));

        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(615.57))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(609.15))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(6.42))));
    }
    ...
    public void testWertpapierKauf13()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(851.21))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(839.79))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(2.52))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(1.90 + 7.00))));
    }
    ...
    public void testWertpapierKauf14()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(361.26))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(350.97))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(9.90 + 0.39))));
    }
    ...
    public void testWertpapierKauf15()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(2503.47))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(2490.75))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(9.90 + 2.82))));
    }
    ...
    public void testWertpapierKauf16()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(1234.56))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(1234.56))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
    ...
    public void testWertpapierKauf17()
    {
        ...
        assertThat(entry.getNote(),
                        is("Ordernummer 123456789.001 | Stückzinsen EUR 6,23 (Zinsvaluta 21.12.2020 13 Tage)"));

        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(10226.61))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(10196.23))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(30.38))));
    }
    ...
    public void testWertpapierKauf22()
    {
        ...
        // check security
        assertThat(results, hasItem(security( //
                        hasIsin("LU0274209237"), hasWkn("DBX1ME"), hasTicker(null), //
                        hasName("Xtrackers MSCI Europe Inhaber-Anteile 1C o.N."), //
                        hasCurrencyCode("EUR"))));

        // check buy sell transaction
        assertThat(results, hasItem(purchase( //
                        hasDate("2025-04-01T09:04:09"), hasShares(2.30287), //
                        hasSource("Kauf22.txt"), //
                        hasNote("Ordernummer 389457606.001"), //
                        hasAmount("EUR", 220.50), hasGrossValue("EUR", 220.50), //
                        hasTaxes("EUR", 0.00), hasFees("EUR", 0.00))));
    }
    ...
    public void testValorCompra02()
    {
        ...
        assertThat(results, hasItem(purchase( //
                        ...
                        hasForexGrossValue("GBP", 1064.43), //
    ...
    public void testValorCompra03()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "Compra03.txt"), errors);
    ...
    public void testWertpapierVerkauf01()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(1887.64))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(1897.54))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
    ...
    public void testWertpapierVerkauf02()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(568.41))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(597.63))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(18.32 + 1.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(9.90))));
    }
    ...
    public void testWertpapierVerkauf03()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(3421.66))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(3431.56))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(9.90))));
    ...
    public void testWertpapierVerkauf04()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(393.10))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(399.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
    ...
    public void testWertpapierVerkauf05()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(7.41))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(15.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(2.52 + 0.13))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(4.94))));
    }
    ...
    public void testWertpapierVerkauf06()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(569.23))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(780.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(193.29 + 10.63))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(6.85))));
    }
    ...
    public void testWertpapierVerkauf07()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(4547.75))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(5852.50))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(561.24 + 50.51 + 30.86 + 561.24 + 50.51 + 30.86))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(19.53))));
    }
    ...
    public void testWertpapierVerkauf08()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(634.34))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(729.54))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(32.14 + 32.14 + 2.89 + 2.89 + 1.76 + 1.76))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(14.90 + 6.72))));

        var grossValueUnit = entry.getPortfolioTransaction().getUnit(Unit.Type.GROSS_VALUE)
                        .orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("USD", Values.Amount.factorize(830.00))));
    }
    ...
    {
        var security = new Security("Kenvue Inc. Registered Shares DL -,001", "EUR");
    ...
    public void testVorabpauschale01()
    {
        ...
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(0.16))));
    ...
    public void testDividende01()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(44.01))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(59.11))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(8.87 + 5.91 + 0.32))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));

        var grossValueUnit = transaction.getUnit(Unit.Type.GROSS_VALUE).orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("USD", Values.Amount.factorize(62.04))));
    }
    ...
    public void testDividende02()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(234.92))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(303.60))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(65.10 + 3.58))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));
    }
    ...
    public void testDividende03()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(58.19))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(89.53))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(31.34))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));
    ...
    {
        var security = new Security("BB Biotech AG Namens-Aktien SF 0,20", "EUR");
    ...
    public void testDividende04()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(38.50))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(55.00))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(16.50))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));
    }
    ...
    public void testDividende05()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(8.94))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(10.52))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(1.58))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));

        var grossValueUnit = transaction.getUnit(Unit.Type.GROSS_VALUE).orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("USD", Values.Amount.factorize(12.90))));
    }
    ...
    public void testDividende06()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(3.90))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(4.58))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(0.68))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));

        var grossValueUnit = transaction.getUnit(Unit.Type.GROSS_VALUE).orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("USD", Values.Amount.factorize(5.56))));
    }

    @Test
    public void testDividende06WithSecurityinEUR()
    {
        var security = new Security("Intel Corp. Registered Shares DL -,001", "EUR");
    ...
    public void testDividende07()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(1.12))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(1.32))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(0.20))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));

        var grossValueUnit = transaction.getUnit(Unit.Type.GROSS_VALUE).orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("USD", Values.Amount.factorize(1.60))));
    }
    ...
    public void testDividende08()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(60.82))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(71.55))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(10.73))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));

        var grossValueUnit = transaction.getUnit(Unit.Type.GROSS_VALUE).orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("USD", Values.Amount.factorize(86.88))));
    }
    ...
    public void testDividende09()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(29.60))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(45.94))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(11.49 + 4.60 + 0.25))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));

        var grossValueUnit = transaction.getUnit(Unit.Type.GROSS_VALUE).orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("USD", Values.Amount.factorize(55.43))));
    }

    @Test
    public void testDividende09WithSecurityinEUR()
    {
        var security = new Security("4,40000% Enbridge Inc. 4,4%.Cum.Red.Pref.Shs.5 CD 25", "EUR");
    ...
    public void testDividende10()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(2.68))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(3.15))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(0.47))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));

        var grossValueUnit = transaction.getUnit(Unit.Type.GROSS_VALUE).orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("USD", Values.Amount.factorize(3.83))));
    }
    ...
    public void testDividende11()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(6.70))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(6.70))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));
    }
    ...
    public void testDividende12()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(72.50))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(72.50))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));
    }
    ...
    public void testDividende13()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(101.32))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(116.84))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(14.72 + 0.80))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));
    }
    ...
    public void testDividende15()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(468.04))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(650.00))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(79.46 + 79.46 + 4.37 + 4.37 + 7.15 + 7.15))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));
    }
    ...
    public void testDividende16()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(61.85))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(61.85))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(0.00))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));
    ...
    {
        var security = new Security("BP PLC Registered Shares DL -,25", "EUR");
    ...
    public void testDividende17()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(3.24))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(3.81))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(0.57))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));

        var grossValueUnit = transaction.getUnit(Unit.Type.GROSS_VALUE).orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("USD", Values.Amount.factorize(4.20))));
    }

    @Test
    public void testDividende17WithSecurityinEUR()
    {
        var security = new Security("PennantPark Floating Rate Cap. Registered Shares o.N.", "EUR");
    ...
    public void testDividende18()
    {
        ...
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(3.62))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(0.54))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));

        var grossValueUnit = transaction.getUnit(Unit.Type.GROSS_VALUE).orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("USD", Values.Amount.factorize(4.00))));
    }

    @Test
    public void testDividende18WithSecurityinEUR()
    {
        var security = new Security("Invesco Mortgage Capital Registered Shares DL -,01", "EUR");
    ...
    public void testDividende19()
    {
        ...
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(25.10))));
        assertThat(transaction.getGrossValue(), is(Money.of("EUR", Values.Amount.factorize(29.53))));
        assertThat(transaction.getUnitSum(Unit.Type.TAX), is(Money.of("EUR", Values.Amount.factorize(4.43))));
        assertThat(transaction.getUnitSum(Unit.Type.FEE), is(Money.of("EUR", Values.Amount.factorize(0.00))));

        var grossValueUnit = transaction.getUnit(Unit.Type.GROSS_VALUE).orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("USD", Values.Amount.factorize(32.50))));
    }

    @Test
    public void testDividende19WithSecurityinEUR()
    {
        var security = new Security("Annaly Capital Management Inc. Registered Shares DL -,01", "EUR");
    ...
    public void testDividende21()
    {
        ...
        // check security
        assertThat(results, hasItem(security( //
                        hasIsin("XS2892988192"), hasWkn("A383QY"), hasTicker(null), //
                        hasName("4,12500% Deutsche Lufthansa AG MTN v.2024(2032/2032)"), //
                        hasCurrencyCode("EUR"))));
        ...
        assertThat(results, hasItem(dividend( //
                        ...
                        hasTaxes("EUR", 20.63 + 1.13), hasFees("EUR", 0.00))));
    }
    ...
    public void testDividendos03()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "Dividendos03.txt"), errors);
    ...
    public void testDividendeStorno01()
    {
        ...
        assertThat(((Transaction) cancellation.getSubject()).getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(24.20))));
    ...
    public void testWertpapierRueckzahlung01()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "Rueckzahlung01.txt"), errors);
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(256.66))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(256.66))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
    ...
    public void testWertpapierRueckzahlung02()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "Rueckzahlung02.txt"), errors);
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(1404.34))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(1417.40))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(12.38 + 0.68))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.FEE),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
    }
    ...
    public void testWertpapierRueckzahlung03()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "Rueckzahlung03.txt"), errors);
        ...
        assertThat(entry.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of("EUR", Values.Amount.factorize(594.00))));
        assertThat(entry.getPortfolioTransaction().getGrossValue(),
                        is(Money.of("EUR", Values.Amount.factorize(594.00))));
        assertThat(entry.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of("EUR", Values.Amount.factorize(0.00))));
    ...
    public void testSteuerrelevanterUmtausch01()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "SteuerrelevanterUmtausch01.txt"),
                        errors);
    ...
    public void testUmtauschEingang01()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "UmtauschEingang01.txt"), errors);
    ...
    public void testUmtauschAusgang01()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "UmtauschAusgang01.txt"), errors);
    ...
    public void testExtraKontoauszug01()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "ExtraKontoauszug01.txt"), errors);
    ...
    public void testExtraKontoauszug03()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "ExtraKontoauszug03.txt"), errors);
    ...
    public void testVLKontoauszug01()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "VLKontoauszug01.txt"), errors);
    ...
    public void testVLKontoauszug02()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "VLKontoauszug02.txt"), errors);
    ...
    public void testVLKontoauszug03()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "VLKontoauszug03.txt"), errors);
